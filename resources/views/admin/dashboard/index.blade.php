                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="d-flex justify-content-between mb-4">
                                                <div class="text-secondary font-weight-medium">Marguerite Pearson
                                                </div>
                                                <div class="small">$233</div>
                                            </div>
                                            <div class="d-flex justify-content-between mb-4">
                                ...
                                <div class="col-12">
                                    <div class="d-md-flex mb-4">
                                        <div class="mr-md-5 mb-4">
                                            <h5 class="mb-1"><i class="typcn typcn-globe-outline mr-1"></i>Online
                                            </h5>
                                    ...
                                    <div class="d-sm-flex justify-content-between">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuSizeButton4"
                                                ...
                                                <a class="dropdown-item" href="#">Tue,18 Oct 2019 - Wed,26
                                                    Oct 2019</a>
                                                <a class="dropdown-item" href="#">Wed,19 Oct 2019 - Thu,26
                                                    Oct 2019</a>
                                            </div>
                                        </div>
                                        <div>
