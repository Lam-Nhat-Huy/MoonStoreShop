                ...
                <div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
                    <form method="POST" action="{{ route('contact.post') }}">
                        ...
                        <div class="bor8 m-b-20 how-pos4-parent">
                            <input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="your-email"
                                placeholder="Your Email Address">
                            <img class="how-pos4 pointer-none" src="{{ asset('assets') }}/images/icons/icon-email.png"
                                alt="ICON">
                        </div>
                ...
                <div class="size-210 bor10 flex-w flex-col-m p-lr-93 p-tb-30 p-lr-15-lg w-full-md">
                    <div class="flex-w w-full p-b-42">
                        ...
                        <div class="size-212 p-t-2">
                            ...
                            <p class="stext-115 cl6 size-213 p-t-18">
                                323C Hang Xoai Phuong Le Binh Quan Cai Rang Can tho Viet Nam
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex-w w-full">
                        ...
                        <div class="size-212 p-t-2">
                            ...
                            <p class="stext-115 cl1 size-213 p-t-18">
                                lamnhathuy0393418721@gmail.com
                            </p>
                        </div>
                    </div>
                </div>
